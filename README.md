...
[Olist](https://www.kaggle.com/datasets/olistbr/brazilian-ecommerce)는 브라질의 실제 이커머스 플랫폼으로, 중소상인과 고객을 연결하는 마켓플레이스입니다. 2016~2018년 실거래 데이터(약 10만 건)를 활용해 이커머스가 공통으로 겪는 네 가지 문제를 AI로 해결하고, 분석에서 끝나지 않고 누구나 사용할 수 있는 웹 서비스로 배포했습니다.
...
상품 카테고리를 원핫 인코딩한 뒤 코사인 유사도로 비슷한 상품을 추천합니다.
